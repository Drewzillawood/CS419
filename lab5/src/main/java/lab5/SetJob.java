 ...
 *
 */
public class SetJob<T extends Mapper<?, ?, ?, ?>, S extends Reducer<?, ?, ?, ?>, U extends InputFormat<?, ?>>
{
	/**
	 * Name of the job
	 */
	...
	/**
	 * Specified FileInputFormat
	 */
	private final Class<U>	inputFormat;
	...
	public SetJob(String jobName, String inputPathName, String outputPathName, int reducerTasks, Class<T> mapperClass,
			Class<S> reducerClass, Class<U> inputFormat)
	...
	public void initiate() throws IOException, ClassNotFoundException, InterruptedException
	{
		...
		j.setJarByClass(JSONRecordParser.class);
		...
		j.setInputFormatClass((Class<? extends InputFormat<?, ?>>) Class.forName(inputFormat.getTypeName()));
