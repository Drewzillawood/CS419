...
public class Experiment_2
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		rows.writeAsText("hdfs:///user/drewu/lab10/exp2/output");
		
		env.execute();
	}
	
	// hashmap allows constant time access to each tuple
	static HashMap<String, Tuple3<String, Integer, Integer>> h = new HashMap<>();
	...
	{	
		...
		public void apply(GlobalWindow w, Iterable<String> i, Collector<Tuple2<String, String>> o) throws Exception
		{
			...
			PriorityQueue<Tuple2<String, Tuple3<String, Integer, Integer>>> p = new PriorityQueue<>(new Experiment_1.Tuple3IntegerComparator());
