...
public class WordCount
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		// per mapper. For this example, the Reduce logic is good enough as the   // 	Here we are just setting up the job 
		// combiner logic. Hence we use the same class.							  // 	with the mapper, combiner, reducer setup
		// However, this is not neccessary and you can write separate Combiner	  //    
		// class.																  //	TokenizerMapper is the mapper class we wrote
		job.setCombinerClass(IntSumReducer.class);								  //
																				  //	IntSumReducer is the reducer class we wrote
		...
		job.setMapOutputKeyClass(Text.class);            /**/ 
														 /*	Output < Key : Value > pairing */	
		// Set the Output Value from the mapper			 /* This is for the mapper */
		job.setMapOutputValueClass(IntWritable.class);	 /**/
														 
		// Set the Output Key from the reducer			 /**/
		// Must match with what the reducer outputs      /**/
		job.setOutputKeyClass(Text.class);				 /* Output < Key : Value > pairing */
		...
		job.setInputFormatClass(TextInputFormat.class);			/**/
																/* Here we just set up the format of the input/output */
		// Output format class									/**/
